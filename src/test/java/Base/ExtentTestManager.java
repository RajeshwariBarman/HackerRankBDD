...
public class ExtentTestManager {
	...
	public static synchronized boolean addScreenShots() {
		...
		ExtentManager.captureScreenshot();
		try {
			testReport.get().info(("<font color=" + "green>" + "Screenshot" + "</font>"),
					MediaEntityBuilder.createScreenCaptureFromPath(ExtentManager.screenshotName).build());
//			testReport.get().log(Status.PASS,"logged in", MediaEntityBuilder.createScreenCaptureFromPath(ExtentManager.screenshotName).build());
		} catch (IOException e) {
